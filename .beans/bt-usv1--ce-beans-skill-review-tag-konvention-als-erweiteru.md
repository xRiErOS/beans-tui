...
status: todo
type: task
created_at: 2026-07-15T14:29:06Z
updated_at: 2026-07-15T14:29:06Z
---

PO-Side-ToDo aus beans-tui-Session (2026-07-15): Die Review-Tag-Konvention gehört in den ce-beans-Skill (lokale Erweiterung; ~/.claude/skills/ce-beans ist Symlink, echtes Verzeichnis unter ~/.agents/skills).
...
Kontext: Review-Cockpit wurde aus beans-tui entfernt (PF-14, beans-tui bean bt-heg9) — Review passiert im Chat, Tags steuern nur den Zustand. lean-stack-Prinzip: Signal statt Zeremonie.
...
[ ] Drift-Net beachten (kein Rename, nur Inhalts-Edit)
